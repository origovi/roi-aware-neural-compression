...
class EngineScaleHyperpriorWithObjEval:
    def __init__(self, args):
        ...
        self.codec_model = ScaleHyperprior(N=128, M=192).to(
            self.device
        )
    ...
    def train(self):
        print(
            f"Starting training of ScaleHyperpriorWithObjEval on {self.device} device."
        )
    ...
    def test(self, model_weights_path):
        print(f"Starting testing of ScaleHyperpriorWithObjEval on {self.device} device.")
    ...
    def _train_one_epoch(self, optimizer: torch.optim.Optimizer,
        ...
        with tqdm(self.train_dataloader, unit="b", desc="Training") as pbar:
            for batch_i, batch in enumerate(pbar):
                ...
                codec_output = self.codec_model.forward(compr_imgs_batch)
